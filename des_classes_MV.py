...
class g:
    ...
    call_inter = call_inter

    # Activity times
    mean_reg_time = mean_reg_time
    mean_gp_time = mean_gp_time
    mean_book_test_time = mean_book_test_time
    mean_call_time = mean_call_time

    # Resource numbers
    number_of_receptionists = number_of_receptionists
    number_of_gps = number_of_gps

    # Branch probabilities
    prob_book_test = prob_book_test
